...
const mockProducts: Product[] = [
    {
      id: 1, type: "VARIABLE", bestRate: 5.2,
      name: "",
      family: "VALUE_FLEX",
      term: "1_YEAR",
      insurable: false,
    ...
    {
      id: 2, type: "VARIABLE", bestRate: 4.8,
      name: "",
      family: "VALUE_FLEX",
      term: "1_YEAR",
      insurable: false,
    ...
    {
      id: 3, type: "VARIABLE", bestRate: 4.8,
      name: "",
      family: "VALUE_FLEX",
      term: "1_YEAR",
      insurable: false,
...
describe("isApplicantComplete", () => {
  ...
  it("returns false when any field is empty", () => {
    expect(
      isApplicantComplete({ ...validApplicant, firstName: "" })
    ).toBe(false);

    expect(
      isApplicantComplete({ ...validApplicant, lastName: "" })
    ).toBe(false);

    expect(
      isApplicantComplete({ ...validApplicant, email: "" })
    ).toBe(false);

    expect(
      isApplicantComplete({ ...validApplicant, phone: "" })
    ).toBe(false);
  });
