...
const ApplicationsListPage = () => {
  ...
  return [...items].sort((a, b) => {
    ...
    const aName = `${aApplicant?.firstName || ""} ${aApplicant?.lastName || ""}`.toLowerCase();
    const bName = `${bApplicant?.firstName || ""} ${bApplicant?.lastName || ""}`.toLowerCase();
                ...
                <table className="applications__table">
                    <thead className="applications__table-header">
                        <tr className="applications__row applications__row--head">
                            <th  className="applications__cell" onClick={() => handleSort("name")}>
                                Name {sortBy === "name" && (sortOrder === "asc" ? "↑" : "↓")}
                            </th>
                            <th  className="applications__cell" onClick={() => handleSort("email")}>
